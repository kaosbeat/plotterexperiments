...
plotter.select_pen(2)
gentop((gentopXbounds[0], 0.3*gentopYsize),(gentopXbounds[1],0.8*gentopYsize),(0,0.1*gentopYsize),(0.2*gentopYsize,gentopYsize),(88,88),1, 0, 0, gentopoffset)
