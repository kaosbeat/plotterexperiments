...
def plotcover(start, end):
	...
	#margins
	marginsfront = [10,10,30,30] #mm [top,bottom,left,right]
	...
	gentopXsize = gentopXbounds[1] - gentopXbounds[0] - 500
	gentopYsize = gentopYbounds[1] - gentopYbounds[0] - 500
	...
	gentopoffset = (-gentopXsize ,-gentopYsize)
	...
	#hpgl.SP(4)
	###def gentop(start,stop,min,max,steps,layer,xpos,ypos,offset=(0,0)): #(0,0),(10000,1000),(0,2000),(2500,5000),(3,2), 3
	gentop((gentopXbounds[0], 0.8*gentopYsize),(gentopXsize,0.2*gentopYsize),(0,0.3*gentopYsize),(0.1*gentopYsize,0.5*gentopYsize),(5,2),9, 0, 0, gentopoffset)
	#plotter.clear()
