...
def getrandompoint(wave, table, Vsize):	
	...
	randpointer = randpointer + int(randpointerjump/randpointerbackrange*2 - random.randint(0, randpointerjump))
	if randpointer < 0:
		randpointer = 0
	if randpointer >= rez:
		randpointer = rez-1
...
somewaves(False, True, [wav1, wav2, wav2, wav1], ["sin", "saw", "cos", "sin", "cos"], [5100, 1000, 6500, 4000, 1000], ["rect", "cross", "cross", "rect", "cross"])  
