...
#r = shapes.group([])
#r.append(shapes.rectangle(2000,1000))



#transforms.offset(r,(0,0))
#plotter.write(r)
plotter.select_pen(1)
#gentop(start,stop,min,max,steps,layer,xpos,ypos): #(0,0),(10000,1000),(0,2000),(2500,5000),(3,2), 3
gentop((0,1000),(3000,1000),(0,100),(500,1000),(3,7),9, 0,0)
plotter.select_pen(2)
gentop((0,600),(3000,200),(0,100),(500,1000),(2,3),4, 0,0)
plotter.select_pen(3)
gentop((0,200),(3000,800),(0,00),(500,1000),(2,3),0, 0,0)

writeword("triangle_yur", 8, "USSR.ttf", 0, 1200)
plotter.select_pen(1)
l = shapes.label(str("sondervan.bandcamp.com/yum"), 0.2,0.2)
#transforms.scale(l, 0.2)
transforms.offset(l, (0,-120))
plotter.write(l)
l = shapes.label(str("4rrt-334d"), 0.2,0.2)
#transforms.scale(l, 0.2)
transforms.offset(l, (0,-350))
plotter.write(l)

#wavedecay(wav3, rez, 1500,1100,0, 2500)
